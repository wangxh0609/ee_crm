...
-->
	...
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	 <tr>
	    <td>登录名：</td>
	    <td><s:textfield name="loginName"></s:textfield> </td><!-- <input type="text" name="loginName" value="tom" /> -->
	    <td>密码：</td>
	    <td><s:password name="loginPwd" showPassword="true"></s:password></td><!-- <input type="password" name="loginPwd" value="81dc9bdb52d04dc20036dbd8313ed055" />  -->
	  </tr>
	 <tr>
	    <td>姓名：</td>
	    <td><s:textfield name="staffName"></s:textfield></td><!-- <input type="text" name="staffName" value="汤姆" />  -->
	    <td>性别：</td>
	    <td>
	 ...
	 <tr>
	    ...
	    <td width="20%">
			...
			<s:select list="allDepartment" name="post.department.depId" listKey="depId" listValue="depName" headerKey="" headerValue="----请--选--择----">
