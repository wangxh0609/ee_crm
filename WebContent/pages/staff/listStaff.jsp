	  ...
	  <tr class="<s:property value="#vs.even ? 'tabtd2' : 'tabtd1'"/>"> 
	    ...
	    <td align="center"><s:property value="post.postName"/></td>
	  	<td width="7%" align="center">
	  		...
	  		<!--   href="${pageContext.request.contextPath}/pages/staff/editStaff.jsp"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img" /></a>-->
	  		<!-- 编辑前的查询操作 -->
	  		<s:a namespace="/" action="staffAction_editUI">
	  			<s:param name="staffId" value="staffId"></s:param><!-- 穿入Id -->
